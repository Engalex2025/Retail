...
public final class SalesHeatmapGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<generated.grpc.SalesMonitor.SalesRequest,
      generated.grpc.SalesMonitor.SalesUpdate> getStreamSalesUpdatesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamSalesUpdates",
      requestType = generated.grpc.SalesMonitor.SalesRequest.class,
      responseType = generated.grpc.SalesMonitor.SalesUpdate.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<generated.grpc.SalesMonitor.SalesRequest,
      generated.grpc.SalesMonitor.SalesUpdate> getStreamSalesUpdatesMethod() {
    io.grpc.MethodDescriptor<generated.grpc.SalesMonitor.SalesRequest, generated.grpc.SalesMonitor.SalesUpdate> getStreamSalesUpdatesMethod;
      ...
      synchronized (SalesHeatmapGrpc.class) {
        if ((getStreamSalesUpdatesMethod = SalesHeatmapGrpc.getStreamSalesUpdatesMethod) == null) {
          SalesHeatmapGrpc.getStreamSalesUpdatesMethod = getStreamSalesUpdatesMethod =
              io.grpc.MethodDescriptor.<generated.grpc.SalesMonitor.SalesRequest, generated.grpc.SalesMonitor.SalesUpdate>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StreamSalesUpdates"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.grpc.SalesMonitor.SalesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.grpc.SalesMonitor.SalesUpdate.getDefaultInstance()))
  ...
  public static abstract class SalesHeatmapImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void streamSalesUpdates(generated.grpc.SalesMonitor.SalesRequest request,
        io.grpc.stub.StreamObserver<generated.grpc.SalesMonitor.SalesUpdate> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                generated.grpc.SalesMonitor.SalesRequest,
                generated.grpc.SalesMonitor.SalesUpdate>(
  ...
  public static final class SalesHeatmapBlockingStub extends io.grpc.stub.AbstractBlockingStub<SalesHeatmapBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<generated.grpc.SalesMonitor.SalesUpdate> streamSalesUpdates(
        generated.grpc.SalesMonitor.SalesRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STREAM_SALES_UPDATES:
          serviceImpl.streamSalesUpdates((generated.grpc.SalesMonitor.SalesRequest) request,
              (io.grpc.stub.StreamObserver<generated.grpc.SalesMonitor.SalesUpdate>) responseObserver);
          break;
        default:
  ...
  private static abstract class SalesHeatmapBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return generated.grpc.SalesMonitor.SalesHeatmapImpl.getDescriptor();
    }
